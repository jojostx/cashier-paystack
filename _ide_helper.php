...
namespace Illuminate\Support\Facades {
   ...
   class Auth
   {
       ...
       *
       * @param mixed $id
       * @return \App\Models\Tenant\User|false 
       * @static 
       */
...
namespace Illuminate\Support {
   ...
   class Collection
   {
       ...
       * @param mixed $nestingDelimiter
       * @param mixed $prefix
       * @static 
       */
      public static function flattenWithKeys($nestingDelimiter = '.', $prefix = '')
      {
         return \Illuminate\Support\Collection::flattenWithKeys($nestingDelimiter, $prefix);
      }
   }
   /**
    * 
